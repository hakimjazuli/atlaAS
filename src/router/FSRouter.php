...
class FSRouter extends FSMiddleware {
    ...
    public function render_get(null|array $url = null, null|array $query_parameter = null) {
        ...
        $this->run_real_route($query_parameter);
    }
    ...
    private function run_real_route(array|null $query_parameter = null) {
        ...
        $this->run_method_with_input_logic($route, $query_parameter);
    }
    ...
    private function run_method_with_input_logic(string $class_name, array|null $query_parameter = null): void {
        ...
        if ($query_parameter !== null) {
            $this->app->request->generate_query_param($query_parameter, $route_);
        }
